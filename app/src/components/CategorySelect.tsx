...
export function CategorySelect({
  ...
  return (
    <div className="mx-auto w-full max-w-6xl px-4 pb-10 pt-0 md:px-6 md:pb-14 lg:px-8">
      <section className="relative isolate left-1/2 right-1/2 min-h-[calc(65svh-5rem)] w-screen -translate-x-1/2 overflow-hidden bg-ink text-paper md:min-h-[calc(70svh-4.5rem)]">
        ...
        <div className="relative flex min-h-[calc(65svh-5rem)] items-center px-4 py-8 md:min-h-[calc(70svh-4.5rem)] md:px-10 md:py-14 lg:px-14 lg:py-18">
          <div>
            ...
            <h2 className="mt-3 text-4xl font-black uppercase leading-none md:text-5xl lg:text-6xl">Every question becomes a keepsake.</h2>
      ...
      <button type="button" onClick={onBrowse} className="group relative isolate mt-6 h-36 w-full overflow-hidden border-4 border-ink bg-ink text-left shadow-[6px_6px_0_#18171b] outline-none md:h-44">
        ...
        <div className="flex h-full items-end p-5 md:p-7">
          <div>
            ...
            <h2 className="mt-1 text-3xl font-black uppercase leading-none text-paper md:text-4xl">Browse the deck</h2>
          </div>
        </div>
      </button>
      ...
      <section ref={faqRef} className="mt-10">
        ...
        <h2 className="mt-2 text-3xl font-black uppercase text-ink md:text-4xl">Frequently asked questions</h2>
...
function FaqItem({ question, answer }: { question: string; answer: string }) {
  ...
  return (
    <div className="border-4 border-ink bg-paper shadow-[5px_5px_0_#18171b]">
      ...
      >
        <span className="text-sm font-black uppercase leading-tight text-ink md:text-base">{question}</span>
